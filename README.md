...
La API de este ejercicio debe contar con, __al menos__, dos modelos principales, uno de ellos será la entidad __User__, a la que añadiremos Films entidad principal.
...
1. Requisitos de MongoDB:
    ...
    - dos colecciones: una será __users__ y Films corresponderá a la Films entidad principal.
